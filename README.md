...
- [obsidian-high-recall](https://github.com/ToussaintKnight/obsidian-high-recall-skill) - Local-first high-recall search for private Obsidian vaults in Codex: reuses Smart Connections vectors when available, falls back to local hybrid search, and returns recall packs without uploading raw notes. ![GitHub stars](https://img.shields.io/github/stars/ToussaintKnight/obsidian-high-recall-skill?style=flat-square)
